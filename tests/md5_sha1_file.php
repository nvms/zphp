...
// with the algo baked in. emit PHP's exact 'Failed to open stream' warning
// text on missing files instead of returning false silently
...
// missing file returns false and emits a warning
